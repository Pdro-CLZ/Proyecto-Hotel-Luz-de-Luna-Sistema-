...
print(f"{len(amenidades)} amenidades creadas o existentes.")
...
print(f"{len(habitaciones)} habitaciones creadas o existentes.")
...
print(f"{count} precios creados o existentes para todas las habitaciones.")
...
print(f"Cliente creado o existente: {cliente}")
